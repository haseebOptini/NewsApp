...
class CoreDataStackManager {
    ...
    enum SQLiteConstant {
        static let fileName = "NewsApplication"
        static let sqliteFileName = fileName + ".sqlite"
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: SQLiteConstant.fileName, withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent(SQLiteConstant.sqliteFileName)
